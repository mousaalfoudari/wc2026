...
const server = http.createServer(async (req, res) => {
  try {
    ...
    if (pathname !== '/' && (pathname.startsWith('/style.css') || pathname.startsWith('/app.js') || pathname.startsWith('/favicon') || pathname.startsWith('/banner') || pathname.startsWith('/login-bg'))) {
